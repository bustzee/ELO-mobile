...
Route::post('/update-user-bank-details', 'App\Http\Controllers\ProfileController@updateUserBankDetails')->name('update-user-bank-details');
...
Route::get('/stream/{id}', [\App\Http\Controllers\LiveStream\LiveStreamController::class, 'showStream'])
    ->where('id', '[0-9]+')
    ->name('stream.live');
Route::post('/save-report', [\App\Http\Controllers\LiveStream\LiveStreamController::class, 'saveStreamReport'])
    ->name('save-report');
Route::post('/save-dispute', [\App\Http\Controllers\LiveStream\LiveStreamController::class, 'saveStreamDispute'])
    ->name('save-dispute');

Route::post('/livestream/{livestream}/like', [\App\Http\Controllers\LiveStream\LiveStreamController::class, 'like'])
    ->name('livestream.like');
Route::delete('/livestream/{livestream}/unlike', [\App\Http\Controllers\LiveStream\LiveStreamController::class, 'unlike'])
    ->name('livestream.unlike');    
Route::get('/leaderboard', 'App\Http\Controllers\LeaderboardController@index')->name('leaderboard');
Route::get('/tutorial-document/{id}', [\App\Http\Controllers\IndexController::class, 'showTutorialDocument'])
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['middleware' => 'role'], function () {
        ...
        Route::get('/reported-streams', [\App\Http\Controllers\Admin\ReportController::class, 'reportedStreams']);
        Route::get('/betting-disputes', [\App\Http\Controllers\Admin\ReportController::class, 'bettingDisputes']);
