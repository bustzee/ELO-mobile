	  ...
	  <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
              ...
              <div class="col-sm-6">
                  <input class="form-check-input" type="checkbox" name="hide_twitch_stream" id="flexCheckDefault" {{ $setting->hide_twitch_stream == 1 ? 'checked' : ''}}>
              </div>
          </div>
                  ...
                  @php
                     $decryptedclientId = null;
                      try {
                          ...
                          echo "Error: Unable to decrypt the value.";
                      }
                  @endphp
               @endif

						<input  style="width:92%; float:left;" type="password" maxlength="255" class="form-control required    " required  name="client_id" id="client_id" value="{{ $decryptedclientId; }}"  >
			  ...
			  <div class="form-group row">
                  ...
                  @php
                     $decryptedUsername = null;
                      try {
                          if($setting->api_username){
                            $decryptedUsername = \Crypt::decryptString($setting->client_id);
                          }
                      } catch (\Illuminate\Contracts\Encryption\DecryptException $e) {
                          echo "Error: Unable to decrypt the value.";
                      }
                  @endphp
						...
						<input style="width:92%; float:left;" type="password" maxlength="255" class="form-control required   " required  name="api_username" id="api_username" value="{{ $decryptedUsername; }}"  >
						<i class="fas fa-eye show_password " style="margin-top: 11px;cursor: pointer;"></i>
						<i class="	fas fa-eye-slash close_password" style="margin-top: 11px;display:none;cursor: pointer;"></i>
			  ...
			  <div class="form-group row">
                  ...
                  @php
                     $decryptedPassword = null;
                      try {
                         if($setting->api_password){
                             $decryptedPassword = \Crypt::decryptString($setting->api_password);
                         }
                      } catch (\Illuminate\Contracts\Encryption\DecryptException $e) {
                          echo "Error: Unable to decrypt the value.";
                      }
                  @endphp
						...
						<input  style="width:92%; float:left;"  type="password" maxlength="255" class="form-control required    " required  name="api_password" id="api_password" value="{{ $decryptedPassword }}"  >
						<i class="fas fa-eye show_password " style="margin-top: 11px;cursor: pointer;"></i>
						<i class="	fas fa-eye-slash close_password" style="margin-top: 11px;display:none;cursor: pointer;"></i>
			  ...
			  <div class="form-group row">
                ...
                @php
                     $decryptedSignature = null;
                      try {
                          if($setting->api_signature){
                             $decryptedSignature = \Crypt::decryptString($setting->api_signature); 
                          }
                      } catch (\Illuminate\Contracts\Encryption\DecryptException $e) {
                          echo "Error: Unable to decrypt the value.";
                      }
                  @endphp
            <input  style="width:92%; float:left;"  type="password" maxlength="255" class="form-control required" required  name="api_signature" id="api_signature" value="{{ $decryptedSignature }}"  >
						<i class="fas fa-eye show_password " style="margin-top: 11px;cursor: pointer;"></i>
						<i class="	fas fa-eye-slash close_password" style="margin-top: 11px;display:none;cursor: pointer;"></i>
