        ...
        <div class="container d-lg-none">
            <nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg">
                ...
                <ul class="navbar-nav">
					...
					@if (auth()->check())
						<li class="nav-item">
							<a class="nav-link fw-bold" href="javascript:;">Balance: {{ auth()->user()->elo_balance }}</a>
						</li>
		...
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-12 col-md order-4 order-md-2">
					  <form action="{{ asset('') }}" method="GET" class="d-flex justify-content-center">
                    <div class="input-group">
                    	
                        <input type="text" class="form-control" name="q" placeholder="Search" value="{{ !empty($search)?$search:'' }}">
                        @if(!empty($search))
