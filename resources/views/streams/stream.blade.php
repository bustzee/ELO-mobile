                            ...
                            <div class="col-md-4">
                                ...
                                @auth
                                    ...
                                    $userAge = $dateOfBirth ? now()->diffInYears($dateOfBirth) : null;
                                     @endphp -->
                                        @if($userAge >= 21)
                                         <button type="button" class="btn btn-danger" data-bs-toggle="modal" id="btn-bet" 
            ...
            <div class="modal-content" style="background-color: #13143e;">
                ...
                <div class="modal-body">
                    ...
                    <p>
                        ...
                        <textarea name="description" id="description" class="form-control empty_input" placeholder="Enter Description" maxlength="220"></textarea>
                    </p>
                    <p>
                        <label>Enter For</label>
                        <input type="text" name="for_text" id="for_text" class="form-control empty_input" placeholder="Enter For" maxlength="100">
                    </p>
                    <p>
                        <label>Enter Against</label>
                        <input type="text" name="against_text" id="against_text" class="form-control empty_input" placeholder="Enter Against" maxlength="100">
                    </p>
 ...
 $(document).ready(function() {
   $('body').on('click', '#submit_report_form', function () {
    //$('#reportForm').on('submit', function(e) {
      ...
      var formData = $('#reportForm').serialize(); // Serialize form data
    // Add stream_id to formData
        formData += '&stream_type=' + encodeURIComponent(stream_type); // Add stream_type to formData
 // Serialize form data
       $.ajax({
