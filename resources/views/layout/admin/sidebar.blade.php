...
<aside class="main-sidebar  elevation-4">
    ...
    @if(auth()->user()->can('view-betting-view-master'))
      <li class="nav-item    {{ (request()->segment(1) == 'bettingview')  ? 'menu-is-opening menu-open' : '' }} ">
          ...
          <li class="nav-item">
            <a href="{{url('tutorials')}}" class="nav-link">Tutorials</a>
          </li>
      ...
      <li class="nav-item    {{ (request()->segment(1) == 'streaming-report')  || (request()->segment(1) == 'twitch-report')  ? 'menu-is-opening menu-open' : '' }} ">
            ...
            <ul class="nav nav-treeview">
             @if(auth()->user()->can('create-betting-view-master'))
              ...
              <li class="nav-item {{ (request()->segment(1) == 'reported-streams') ? 'active' :'' }}">
                <a href="{{url('reported-streams')}}" class="nav-link">
                    <p>Reported Streams </p>
                </a>
              </li>


              <li class="nav-item">
                <a href="{{url('betting-disputes')}}" class="nav-link">
                    <p>Betting Disputes</p>
                </a>
              </li>
