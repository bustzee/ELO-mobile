...
class UserController extends Controller
{
    ...
    public function registeraccount(Request $req)
    {
        ...
        if ($userExists == null) {
            ...
            $dateOfBirth = Carbon::parse($req->date_of_birth);
            if ($dateOfBirth->isFuture()) {
                return back()->withErrors(['date_of_birth' => 'The date of birth cannot be in the future.'])->withInput();
            }
